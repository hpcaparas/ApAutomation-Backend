...
import com.apautomation.requests.ResetPasswordRequest;
...
public class UserController {
	...
	@PostMapping("/employee/resetPass/")
	@PreAuthorize("hasRole('USER') or hasRole('MODERATOR') or hasRole('ADMIN') or hasRole('FINANCE')")
	ResponseEntity updateUserPass(@RequestBody ResetPasswordRequest resetPasswordRequest) {
		try { 
			userRepository.resetPassword(encoder.encode(resetPasswordRequest.getNewPassword()), resetPasswordRequest.getUsername());
		}catch (Exception ex) {
